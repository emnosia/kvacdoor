        ...
        <div class="row mb-5 mt-2">
            <div class="col-12 col-md-5 d-flex align-items-center justify-content-center mb-2 mb-md-0">
                <div class="d-flex align-items-center justify-content-center">
                    <img src="/assets/img/banner/premium-access.png" style="width: 90%;" class="img-fluid img-thumbnail img-circle" alt="KvacDoor">
                </div>
            </div>
            <div class="col-12 col-md-6">
                <h5>Premium Access - Lifetime Subscription</h5>
                <div class="ecommerce-details-price d-flex flex-wrap">

                    <p class="text-primary font-medium-3 mr-1 mb-0">£50.00</p>
                </div>
                <hr>
                <p>With KVacDoor Premium Access you can enjoy exclusive benefits and contribute to the development of KVacDoor.
                ...
                <div class="d-flex flex-column flex-sm-row">
                    <a href="/external?url=https%3A%2F%2Fshoppy.gg%2Fproduct%2FJV5lx9X" target="_blank">
...
<?php
        Logs::AddLogs(
        "User ".$AUTHUSER['username']." visited the premium access market page.", 
        "warning", 
        "fa fa-shopping-cart"
    );
?>
